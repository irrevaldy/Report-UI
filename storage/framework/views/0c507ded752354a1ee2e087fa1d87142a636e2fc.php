                    ...
                    <!-- <div class="left">
                      ...
                      <div class="col-md-4">
                        <div style="padding-left: 100px; border-right: 2px solid gray">
                          ...
                          <p class="number countup text-primary" data-from="0" data-to="<?php echo e($total_branch); ?>" style="font-size: 42px">5,100</p>
                      ...
                      <div class="col-md-4">
                        <div style="padding-left: 100px; border-right: 2px solid gray">
                          ...
                          <p class="number countup text-primary" data-from="0" data-to="<?php echo e($total_store); ?>" style="font-size: 42px">100</p>
                      ...
                      <div class="col-md-4">
                        <div style="padding-left: 100px">
                          ...
                          <p class="number countup text-primary" data-from="0" data-to="<?php echo e($total_terminal); ?>" style="font-size: 42px">100</p>
