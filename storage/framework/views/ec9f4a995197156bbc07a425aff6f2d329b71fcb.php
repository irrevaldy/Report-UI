...
<style type="text/css">
  ...
  <div class="header panel-header" style="border-bottom: none;">
      <h2><i class="fas fa-home"></i> <strong>Download Detail Report - Corporate</strong></h3>
  </div>
  <div class="row">
    <div class="col-md-4">
      ...
      <div class="panel no-bd bd-3 panel-stat">
          ...
          <div class="panel-body p-15 p-b-0">
              <div class="panel-content widget-info">
                    ...
                    <div class="row">
                      <form id="ListReportTable_form" method="POST" action="/download_detail_report_corporate/filter_report_table">
                  ...
                  <div class="row" id="box-result" style="display:none">
                    <form id="listReport_form" method="POST" action="/download_detail_report_corporate/zip_list_report">
    ...
    <div class="panel no-bd bd-3 panel-stat">
        ...
        <div class="panel-body p-15 p-b-0">
            <div class="panel-content widget-info">
                  ...
                  <div class="row">
                    <form id="ListReportSettlementTable_form" method="POST" action="/download_detail_report_corporate/filter_report_table_settlement">
                ...
                <div class="row" id="box-result2" style="display:none">
                  <form id="listReportSettlement_form" method="POST" action="/download_detail_report_corporate/zip_list_report">
                  <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
...
$("#ListReportTable_form").submit(function(e) {
    ...
    $.ajax({
      ...
      url: '/download_detail_report_corporate/filter_report_table',
...
$("#ListReportSettlementTable_form").submit(function(e) {
    ...
    $.ajax({
      ...
      url: '/download_detail_report_corporate/filter_report_table_settlement',
      headers: {'X-CSRF_TOKEN': "<?php echo e(csrf_token()); ?>" },
        success: function(data){
