            ...
            <div class="panel">
				...
				<div class="panel-content pagination2 table-responsive">
                    <table  class="table" id="table1" >
                        ...
                        <?php $__currentLoopData = $data['subgroup_data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td> 
                                        ...
                                        <a data-toggle="modal" data-target="#editModal" style="cursor: pointer;" onClick="edit('<?php echo e($value['id']); ?>', '<?php echo e($value['user_group_id']); ?>', '<?php echo e($value['subgroup_name']); ?>', '<?php echo e($value['description']); ?>')" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a> 
                                    
                                        <!-- <a data-toggle="modal" data-target="#editModal" style="cursor: pointer;" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a>  -->
                                    
                                    |
                                    
                                        <a data-toggle="modal" data-target="#deleteModal" style="cursor: pointer;" onClick="delete_subgroup('<?php echo e($value['id']); ?>', '<?php echo e($value['subgroup_name']); ?>')" ><i class="fa fa-times" aria-hidden="true"></i>Delete</a> 
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    //if( contains.call(priv_list, 'SUBGROUP_E') == true || <?php echo e(Session::get('user_subgroup_id')); ?> == '1' ) {
                    ...
                    //if( contains.call(priv_list, 'SUBGROUP_D ') == true || <?php echo e(Session::get('user_subgroup_id')); ?> == '1' ) {
