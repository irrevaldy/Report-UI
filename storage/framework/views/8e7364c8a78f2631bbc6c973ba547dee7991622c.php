                    ...
                    <table  class="table" id="table1" >
                        ...
                        <?php $__currentLoopData = $data['package_data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td> <?php echo e(str_ireplace("<br />", "\r\n", $value['description'])); ?> </td>

                                <td> 

                                    
                                        <a data-toggle="modal" data-target="#editModal" style="cursor: pointer;" onClick="edit('<?php echo e($value['id']); ?>', '<?php echo e($value['package_name']); ?>', '<?php echo e($value['description']); ?>')" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a> 
                                    
                                        <!-- <a data-toggle="modal" data-target="#editModal" style="cursor: pointer;" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a>  -->
                                    
                                    |
                                    
                                        <a data-toggle="modal" data-target="#deleteModal" style="cursor: pointer;" onClick="delete_package('<?php echo e($value['id']); ?>', '<?php echo e($value['package_name']); ?>')" ><i class="fa fa-times" aria-hidden="true"></i>Delete</a> 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row" style="padding-top: 10px;">
                    <?php $__currentLoopData = $data['privilege_data']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                    <div class='col-md-4'>
                        <div class='form-group'>
                            <div class='icheck-list '>
                                <label><input type='checkbox' class='new_privilege' id='' data-checkbox='icheckbox_square-blue' value="<?php echo e($value['id']); ?>"> <?php echo e($value['privilege_name']); ?> </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-body">
                ...
                <div class="row" style="padding-top: 10px;">
                    ...
                    <div class='col-md-4'>
                        <div class='form-group'>
                            <div class='icheck-list '>
                                <label><input type='checkbox' class='edit_privilege' id="edit_privilege_<?php echo e($value['id']); ?>" data-checkbox='icheckbox_square-blue' value="<?php echo e($value['id']); ?>"> <?php echo e($value['privilege_name']); ?> </label>
                            </div>
                        </div>
                    </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    //if( contains.call(priv_list, 'PACKAGE_E') == true || <?php echo e(Session::get('user_subgroup_id')); ?> == '1' ) {
                    ...
                    //if( contains.call(priv_list, 'PACKAGE_D') == true || <?php echo e(Session::get('user_subgroup_id')); ?> == '1' ) {
