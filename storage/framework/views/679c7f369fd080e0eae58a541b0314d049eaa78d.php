          ...
          <ul class="nav nav-sidebar navigation" id="navigation">
            ...
            <li class="nav-parent ">
              ...
              <ul class="children collapse">
                ...
                <?php if( in_array('SERPRO_ACQ_V', $priv)  ): ?> <li><a href="/download_provider_by_acquirer" title="Acquirer Revenue Report"> Acquirer Revenue Report </a></li> <?php endif; ?>
                <?php if( in_array('SERPRO_ISS_V', $priv)  ): ?> <li><a href="#"> By Issuer </a></li> <?php endif; ?>
                <?php if( in_array('SERPRO_CORP_V', $priv)  ): ?> <li><a href="/download_provider_by_corporate" title="Corporate Revenue Report"> Corporate Revenue Report </a></li> <?php endif; ?>
                ...
                <?php if( in_array('SERPRO_DREP_V', $priv)  ): ?> <li><a href="/download_detail_report_provider" title="Download Detail Report"> Download Detail Report </a></li> <?php endif; ?>
                <?php if( in_array('SERPRO_DREC_V', $priv)  ): ?> <li><a href="/download_recon_report_provider" title="Download Reconciliation Report"> Download Reconciliation Report </a></li> <?php endif; ?>
            ...
            <li class="nav-parent ">
              ...
              <ul class="children collapse">
                ...
                <?php if( in_array('ACQ_MER_V', $priv)  ): ?> <li><a href="/download_acquirer_by_merchant" title="Revenue By Merchant"> Revenue By Merchant </a></li> <?php endif; ?>
                <?php if( in_array('ACQ_ONOFF_V', $priv)  ): ?> <li><a href="/download_acquirer_onus_offus_by_merchant" title="On Us & Off Us By Merchant"> On Us & Off Us By Merchant </a></li> <?php endif; ?>
                <?php if( in_array('ACQ_DREP_V', $priv)  ): ?> <li><a href="/download_detail_report_acquirer" title="Download Detail Report"> Download Detail Report </a></li> <?php endif; ?>
                <?php if( in_array('ACQ_DREC_V', $priv)  ): ?> <li><a href="/download_recon_report_acquirer" title="Download Reconciliation Report"> Download Reconciliation Report </a></li> <?php endif; ?>
              </ul>
            </li>
            <?php endif; ?>
            ...
            <li class="nav-parent ">
              ...
              <ul class="children collapse">
                ...
                <?php if( in_array('MER_ACQ_V', $priv)  ): ?> <li><a href="/download_merchant_by_acquirer" title="Revenue By Acquirer"> Revenue By Acquirer </a></li> <?php endif; ?>
                <?php if( in_array('MER_BRA_V', $priv)  ): ?> <li><a href="/download_merchant_by_branch" title="Revenue By Branch"> Revenue By Branch </a></li> <?php endif; ?>
                <?php if( in_array('MER_STO_V', $priv)  ): ?> <li><a href="#"> By Store </a></li> <?php endif; ?>
                <?php if( in_array('MER_T5BRA_V', $priv)  ): ?> <li><a href="/download_merchant_top10_highest_branch" title="Top Ten Highest Branch Revenue"> Top Ten Highest Branch Revenue </a></li> <?php endif; ?>
                <?php if( in_array('MER_DREP_V', $priv)  ): ?> <li><a href="/download_detail_report_merchant" title="Download Detail Report"> Download Detail Report </a></li> <?php endif; ?>
                <?php if( in_array('MER_DREC_V', $priv)  ): ?> <li><a href="/download_recon_report_merchant" title="Daily Reconciliation Report"> Download Reconciliation Report </a></li> <?php endif; ?>
              </ul>
            </li>
            <?php endif; ?>
	      ...
	      in_array('BRA_DREC_V', $priv)
            ...
            <li class="nav-parent ">
              ...
              <ul class="children collapse">
                ...
                <?php if( in_array('STO_DREP_V', $priv)  ): ?> <li><a href="#"> Download Detail Report </a></li> <?php endif; ?>
                <?php if( in_array('STO_DREC_V', $priv)  ): ?> <li><a href="#"> Download Reconciliation Report </a></li> <?php endif; ?>
              <!--
