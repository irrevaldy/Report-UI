      ...
      <div class="panel no-bd bd-3 panel-stat">
          ...
          <div class="panel-body p-15 p-b-0">
              <div class="panel-content widget-info">
                ...
                <div class="row">
                  <form id="ListReportSettlementTable_form" method="POST" action="/download_recon_report_acquirer/filter_report_table_settlement">
<!--
                  <div class="col-md-3">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Acquirer</label>
...
-->
                  ...
                  <div class="row" id="box-result2" style="display:none">
                    <form id="listReportSettlement_form" method="POST" action="/download_recon_report_acquirer/zip_list_report">
                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
...
$("#ListReportSettlementTable_form").submit(function(e) {
    ...
    $.ajax({
      ...
      url: '/download_recon_report_acquirer/filter_report_table_settlement',
      headers: {'X-CSRF_TOKEN': "<?php echo e(csrf_token()); ?>" },
        success: function(data){
