...
class DownloadMerchantTop10HighestBranch extends Controller
{
   	public function __construct(){ }

    public function index(Request $request)
    {
      return view('download_merchant_top10_highest_branch');
    }
    ...
    public function FilterReportTable(Request $request)
    {
      ...
      $form_post = $client->request('POST', config('constants.api_serverv').'merchant_top10_highest_branch_filtered', [
        'json' => [
          //'branch' => $branch,
          'range' => $range,
          'date' => $date,
