...
class DownloadReconReportCorporateController extends Controller
{
    ...
    {
      return view('download_recon_report_corporate');
    }
    ...
    public function GetListReport(Request $request)
    {
      ...
      $form_post = $client->request('POST', config('constants.api_serverv').'list_recon_report', [
        'json' => [
          'username' => $username
        ]
      ]);
    ...
    public function FilterReportTable(Request $request)
    {
      ...
      $form_post = $client->request('POST', config('constants.api_serverv').'list_recon_report_filtered', [
        'json' => [
          'branch' => $branch,
          'range' => $range,
          'date' => $date,
    ...
    public function FilterReportTableSettlement(Request $request)
    {
      ...
      $form_post = $client->request('POST', config('constants.api_serverv').'list_recon_report_filtered_settlement', [
        'json' => [
          'branch' => $branch,
          'range' => $range,
          'date' => $date,
