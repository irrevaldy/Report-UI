...
class DownloadDetailReportBranchController extends Controller
{
    ...
    {
      return view('download_detail_report_branch');
    }
    ...
    public function GetListReport(Request $request)
    {
      ...
      $form_post = $client->request('POST', config('constants.api_serverv').'list_detail_report_branch', [
        'json' => [
          'username' => $username
        ]
      ]);
    ...
    public function FilterReportTable(Request $request)
    {
      ...
      $form_post = $client->request('POST', config('constants.api_serverv').'list_detail_report_filtered_branch', [
        'json' => [
          'range' => $range,
          'date' => $date,
          'username' => $username
    ...
    public function FilterReportTableSettlement(Request $request)
    {
      ...
      $form_post = $client->request('POST', config('constants.api_serverv').'list_detail_report_filtered_branch_settlement', [
        'json' => [
          'range' => $range,
          'date' => $date,
          'username' => $username
