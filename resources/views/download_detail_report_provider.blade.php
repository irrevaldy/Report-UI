...
<style type="text/css">
  ...
  <div class="header panel-header" style="border-bottom: none;">
      <h2><i class="fas fa-home"></i> <strong>Download Detail Report - Service Provider</strong></h3>
  </div>
  <div class="row">
    <div class="col-md-4">
      ...
      <div class="panel no-bd bd-3 panel-stat">
          ...
          <div class="panel-body p-15 p-b-0">
              <div class="panel-content widget-info">
                    ...
                    <div class="row">
                      <form id="ListReportTable_form" method="POST" action="/download_detail_report_provider/filter_report_table">
                  ...
                  <div class="row" id="box-result" style="display:none">
                    <form id="listReport_form" method="POST" action="/download_detail_report_provider/zip_list_report">
    ...
    <div class="panel no-bd bd-3 panel-stat">
        ...
        <div class="panel-body p-15 p-b-0">
            <div class="panel-content widget-info">
                  ...
                  <div class="row">
                    <form id="ListReportSettlementTable_form" method="POST" action="/download_detail_report_provider/filter_report_table_settlement">

                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Branch</label>
                        <select class="form-control select2 selectBranch" name="settlement_branch_code" id="settlement_branch_code" style="width: 100%;" required>
                          <option value=""></option>
                          </select>
                          </div><!-- /.input group -->
                    </div>
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        ...
                        <div class="input-group date">
                          <input type="text" name="date" id="settlementDetailDate" class="form-control readonly" placeholder="Select Date" required="required" />
                          <div class="input-group-addon">
                            <i class="fa fa-calendar"></i>
                          </div>
                        </div>
                ...
                <div class="row" id="box-result2" style="display:none">
                  <form id="listReportSettlement_form" method="POST" action="/download_detail_report_provider/zip_list_report">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
...
$(document).ready(function(){
  ...
  $.ajax({
    dataType: 'JSON',
    type: 'GET',
    url: '/download_detail_report_provider/get_list_report',
...
$("#ListReportTable_form").submit(function(e) {
    ...
    $.ajax({
      ...
      url: '/download_detail_report_provider/filter_report_table',
...
$("#ListReportSettlementTable_form").submit(function(e) {
    ...
    $.ajax({
      type: 'POST',
      data: { branch_code : $('#settlement_branch_code option:selected').val(),
              range : $('#settlement_range option:selected').val(),
              detailDate : $('#settlementDetailDate').val()
            },
      url: '/download_detail_report_provider/filter_report_table_settlement',
      headers: {'X-CSRF_TOKEN': "{{ csrf_token() }}" },
        success: function(data){
