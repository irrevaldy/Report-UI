      ...
      <div class="panel no-bd bd-3 panel-stat">
          ...
          <div class="panel-body p-15 p-b-0">
              <div class="panel-content widget-info">
                ...
                <div class="row">
                  <form id="ListReportTable_form" method="POST" action="/download_recon_report_corporate/filter_report_table">
                  ...
                  <div class="row" id="box-result" style="display:none">
                    <form id="listReport_form" method="POST" action="/download_recon_report_corporate/zip_list_report">
      ...
      <div class="panel no-bd bd-3 panel-stat">
          ...
          <div class="panel-body p-15 p-b-0">
              <div class="panel-content widget-info">
                ...
                <div class="row">
                  <form id="ListReportSettlementTable_form" method="POST" action="/download_recon_report_corporate/filter_report_table">
                  ...
                  <div class="row" id="box-result2" style="display:none">
                    <form id="listReportSettlement_form" method="POST" action="/download_recon_report_corporate/zip_list_report">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
...
$("#ListReportSettlementTable_form").submit(function(e) {
    ...
    $.ajax({
      ...
      url: '/download_recon_report_merchant/filter_report_table_settlement',
      headers: {'X-CSRF_TOKEN': "{{ csrf_token() }}" },
        success: function(data){
