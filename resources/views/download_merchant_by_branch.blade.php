      ...
      <div class="panel no-bd bd-3 panel-stat">
          ...
          <div class="panel-body p-15 p-b-0">
              <div class="panel-content widget-info">
                    ...
                    <div class="row">
                      <form id="ListReportTable_form" method="POST" action="/download_merchant_monthly_by_branch/filter_report_table">
                  ...
                  <div class="row" id="box-result" style="display:none">
                    <form id="listReport_form" method="POST" action="/download_merchant_monthly_by_branch/zip_list_report">
...
$("#ListReportTable_form").submit(function(e) {
  ...
  var x = document.getElementById("box-result");
    ...
    $.ajax({
      ...
      url: '/download_merchant_by_branch/filter_report_table',
