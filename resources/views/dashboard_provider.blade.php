...
<style type="text/css">
    ...
    <div class="row tile_count">
      ...
      <div class="col-md-6 hov_effect" style="padding-left: 20px">
        ...
        <div>
          <canvas id="amount_top5highacquirer_chart"  class="full" height="100"/>
        </div>
      </div>
      ...
      <div class="col-md-6 hov_effect" style="padding-left: 20px">
        ...
        <div>
          <canvas id="amount_top5lowacquirer_chart" class="full" height="100"></canvas>
        </div>
      </div>
    ...
    <div class="row tile_count">
      ...
      <div class="col-md-6 hov_effect" style="padding-left: 20px">
        ...
        <div>
          <canvas id="amount_top5highmerchant_chart"  class="full" height="100"/>
        </div>
      </div>

      <div class="col-md-6 hov_effect" style="padding-left: 20px">
        <h3><strong>Top 5 Merchant Lowest Amount</strong> Charts</h3>
        <div>
          <canvas id="amount_top5lowmerchant_chart" class="full" height="100"></canvas>
        </div>
      </div>
...
@section('javascript')
    ...
    var last_month                  = 7;
    var top5high_amount_bank        = <?php echo json_encode($top5high_amount_bank); ?>;
    var top5low_amount_bank         = <?php echo json_encode($top5low_amount_bank); ?>;
    var top5high_amount_merchant    = <?php echo json_encode($top5high_amount_merchant); ?>;
    var top5low_amount_merchant     = <?php echo json_encode($top5low_amount_merchant); ?>;
    // var total_trx_cardtype  = <?php //echo json_encode($total_trx_cardtype); ?>;
    // var total_trx_type  = <?php //echo json_encode($total_trx_type); ?>;
    
    // console.log(total_amount);

    console.log(top5high_amount_bank);
    ...
    var amount_top5highdata_acquirer = {
      labels: [ last_day ],
      datasets: [{
        label: "top5high_amount_bank[0].FNAME",
        backgroundColor: color(window.chartColors.red).alpha(0.9).rgbString(),
        borderColor: window.chartColors.red,
        borderWidth: 1,
        data: [ "1213" ]
        //data: [ "top5high_amount_bank[0].total_amount" ]
      },{
        label: "top5high_amount_bank[1].FNAME",
        backgroundColor: color(window.chartColors.orange).alpha(0.9).rgbString(),
        borderColor: window.chartColors.orange,
        data: [ "897" ]
        // data: [ "top5high_amount_bank[1].total_amount" ]
      },{
        label: "top5high_amount_bank[2].FNAME",
        backgroundColor: color(window.chartColors.yellow).alpha(0.9).rgbString(),
        borderColor: window.chartColors.yellow,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "793" ]
        // data: [ "top5high_amount_bank[2].total_amount" ]
      },{
        label: "top5high_amount_bank[3].FNAME",
        backgroundColor: color(window.chartColors.blue).alpha(0.9).rgbString(),
        borderColor: window.chartColors.blue,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "648" ]
        //data: [ "top5high_amount_bank[3].total_amount" ]
      },{
        label: "top5high_amount_bank[4].FNAME",
        backgroundColor: color(window.chartColors.green).alpha(0.9).rgbString(),
        borderColor: window.chartColors.green,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "573" ]
        //data: [ "top5high_amount_bank[4].total_amount" ]
      }]

    };
   
    var amount_top5lowdata_acquirer = {
      labels: [ last_day ],
      datasets: [{
        label: "top5low_amount_bank[0].FNAME",
        backgroundColor: color(window.chartColors.red).alpha(0.9).rgbString(),
        borderColor: window.chartColors.red,
        borderWidth: 1,
        data: [ "28" ]
        //data: [ "top5low_amount_bank[0].total_amount" ]
      },{
        label: "top5low_amount_bank[1].FNAME",
        backgroundColor: color(window.chartColors.orange).alpha(0.9).rgbString(),
        borderColor: window.chartColors.orange,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "34" ]
        //data: [ "top5low_amount_bank[1].total_amount" ]
      },{
        label: "top5low_amount_bank[2].FNAME",
        backgroundColor: color(window.chartColors.yellow).alpha(0.9).rgbString(),
        borderColor: window.chartColors.yellow,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "49" ]
        //data: [ "top5low_amount_bank[2].total_amount" ]
      },{
        label: "top5low_amount_bank[3].FNAME",
        backgroundColor: color(window.chartColors.blue).alpha(0.9).rgbString(),
        borderColor: window.chartColors.blue,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "69" ]
        //data: [ "top5low_amount_bank[3].total_amount" ]
      },{
        label: "top5low_amount_bank[4].FNAME",
        backgroundColor: color(window.chartColors.green).alpha(0.9).rgbString(),
        borderColor: window.chartColors.green,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "76" ]
        //data: [ "top5low_amount_bank[4].total_amount" ]
      }]

    };

    var amount_top5highdata_merchant = {
      labels: [ last_day ],
      datasets: [{
        label: "top5high_amount_merchant[0].FMERCHNAME",
        backgroundColor: color(window.chartColors.red).alpha(0.9).rgbString(),
        borderColor: window.chartColors.red,
        borderWidth: 1,
        data: [ "793" ]
        //data: [ "top5high_amount_merchant[0].total_amount" ]
      },{
        label: "top5high_amount_merchant[1].FMERCHNAME",
        backgroundColor: color(window.chartColors.orange).alpha(0.9).rgbString(),
        borderColor: window.chartColors.orange,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "693" ]
        //data: [ "top5high_amount_merchant[1].total_amount" ]
      },{
        label: "top5high_amount_merchant[2].FMERCHNAME",
        backgroundColor: color(window.chartColors.yellow).alpha(0.9).rgbString(),
        borderColor: window.chartColors.yellow,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "455" ]
        //data: [ "top5high_amount_merchant[2].total_amount" ]
      },{
        label: "top5high_amount_merchant[3].FMERCHNAME",
        backgroundColor: color(window.chartColors.blue).alpha(0.9).rgbString(),
        borderColor: window.chartColors.blue,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "432" ]
        //data: [ "top5high_amount_merchant[3].total_amount" ]
      },{
        label: "top5high_amount_merchant[4].FMERCHNAME",
        backgroundColor: color(window.chartColors.green).alpha(0.9).rgbString(),
        borderColor: window.chartColors.green,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "386" ]
        //data: [ "top5high_amount_merchant[4].total_amount" ]
      }]

    };
   
    var amount_top5lowdata_merchant = {
      labels: [ last_day ],
      datasets: [{
        label: "top5low_amount_merchant[0].FMERCHNAME",
        backgroundColor: color(window.chartColors.red).alpha(0.9).rgbString(),
        borderColor: window.chartColors.red,
        borderWidth: 1,
        data: [ "22" ]
        //data: [ "top5low_amount_merchant[0].total_amount" ]
      },{
        label: "top5low_amount_merchant[1].FMERCHNAME",
        backgroundColor: color(window.chartColors.orange).alpha(0.9).rgbString(),
        borderColor: window.chartColors.orange,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "35" ]
        //data: [ "top5low_amount_merchant[1].total_amount" ]
      },{
        label: "top5low_amount_merchant[2].FMERCHNAME",
        backgroundColor: color(window.chartColors.yellow).alpha(0.9).rgbString(),
        borderColor: window.chartColors.yellow,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "46" ]
        //data: [ "top5low_amount_merchant[2].total_amount" ]
      },{
        label: "top5low_amount_merchant[3].FMERCHNAME",
        backgroundColor: color(window.chartColors.blue).alpha(0.9).rgbString(),
        borderColor: window.chartColors.blue,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "58" ]
        //data: [ "top5low_amount_merchant[3].total_amount" ]
      },{
        label: "top5low_amount_merchant[4].FMERCHNAME",
        backgroundColor: color(window.chartColors.green).alpha(0.9).rgbString(),
        borderColor: window.chartColors.green,
        // hoverBackgroundColor: "rgba(117,214,195, 0.9)",
        data: [ "78" ]
        //data: [ "top5low_amount_merchant[4].total_amount" ]
      }]
    ...
    window.onload = function() {
      ...
      var chart_highamount_acquirer = document.getElementById('amount_top5highacquirer_chart').getContext('2d');
      window.myBar = new Chart(chart_highamount_acquirer, {
        type: 'bar',
        data: amount_top5highdata_acquirer,
        options: {
          responsive: true,
          legend: {
            position: 'top',
      ...
      var chart_lowamount_acquirer = document.getElementById('amount_top5lowacquirer_chart').getContext('2d');
      window.myBar = new Chart(chart_lowamount_acquirer, {
        type: 'bar',
        data: amount_top5lowdata_acquirer,
        options: {
          responsive: true,
          legend: {
            position: 'top',
      ...
      var chart_highamount_merchant = document.getElementById('amount_top5highmerchant_chart').getContext('2d');
      window.myBar = new Chart(chart_highamount_merchant, {
        type: 'bar',
        data: amount_top5highdata_merchant,
        options: {
          responsive: true,
          legend: {
            position: 'top',
      ...
      var chart_lowamount_merchant = document.getElementById('amount_top5lowmerchant_chart').getContext('2d');
      window.myBar = new Chart(chart_lowamount_merchant, {
        type: 'bar',
        data: amount_top5lowdata_merchant,
        options: {
          responsive: true,
          legend: {
            position: 'top',
