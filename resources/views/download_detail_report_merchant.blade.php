          ...
          <div class="panel-body p-15 p-b-0">
              <div class="panel-content widget-info">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group">
                          <label for="exampleInputEmail1" id='detailHost'>Transaction Date</label>
    ...
    <div class="panel no-bd bd-3 panel-stat">
        ...
        <div class="panel-body p-15 p-b-0">
            <div class="panel-content widget-info">
                  ...
                  <div class="row">
                    <form id="ListReportSettlementTable_form" method="POST" action="/download_detail_report_merchant/filter_report_table_settlement">
                    ...
                    <div class="col-md-3">
                      <div class="form-group">
                        <label for="exampleInputEmail1" id='settlementDetailHost'>Settlement Date</label>
                        <div class="input-group date">
                  ...
                  <form id="listReportSettlement_form" method="POST" action="/download_detail_report_merchant/zip_list_report">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
...
$("#ListReportSettlementTable_form").submit(function(e) {
  ...
  var x = document.getElementById("box-result2");
    ...
    $.ajax({
      ...
      url: '/download_detail_report_merchant/filter_report_table_settlement',
      headers: {'X-CSRF_TOKEN': "{{ csrf_token() }}" },
        success: function(data){
