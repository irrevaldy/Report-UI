                        ...
                        @foreach ($data['group_data'] as $key => $value)
                            <tr>
                                ...
                                <td> 
                                        ...
                                        <a data-toggle="modal" data-target="#editModal" style="cursor: pointer;" onClick="edit('{{ $value['id'] }}', '{{ $value['package_id'] }}', '{{ $value['group_fullname'] }}', '{{ $value['description'] }}', '{{ $value['group_active'] }}')" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a> 
                                    
                                        <!-- <a data-toggle="modal" data-target="#editModal" style="cursor: pointer;" ><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit</a>  -->
                                    
                                    |
                                    
                                        <a data-toggle="modal" data-target="#deleteModal" style="cursor: pointer;" onClick="delete_group('{{ $value['id'] }}', '{{ $value['group_fullname'] }}')" ><i class="fa fa-times" aria-hidden="true"></i>Delete</a>
                        ...
                        <div class='col-md-4'>
                            <div class='form-group'>
                                <div class='icheck-list '>
                                    <label><input type='checkbox' class='new_filterType' id='' data-checkbox='icheckbox_square-blue' value="{{ $value['id'] }}"> {{ $value['name'] }} </label>
                                </div>
                            </div>
                        </div>   
                    @endforeach
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    //if( contains.call(priv_list, 'GROUP_E') == true || {{ Session::get('user_subgroup_id') }} == '1' ) {
                    ...
                    //if( contains.call(priv_list, 'GROUP_D') == true || {{ Session::get('user_subgroup_id') }} == '1' ) {
