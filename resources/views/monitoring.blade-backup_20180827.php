...
<style type="text/css">
    ...
    <div class="row tile_count">
      <div class="panel transparent">
        <div class="col-md-6 hov_effect">
          <h3><strong>Average Processing Time</strong> Charts - Last 30 Days</h3>
          <!-- <p>A line chart is a way of plotting data points on a line.<br>
            Often, it is used to show trend data, and the comparison of two data sets.
          </p> -->
          <canvas id="proccessing-time-monthly" class="full" height="100px"></canvas>
        </div>
        <div class="col-md-6 hov_effect">
          <h3><strong>Average Processing Time</strong> Charts - Last 24 Hours</h3>
          <!-- <p>A line chart is a way of plotting data points on a line.<br>
            Often, it is used to show trend data, and the comparison of two data sets.
          </p> -->
          <canvas id="proccessing-time-hourly" class="full" height="100px"></canvas>
        </div>
      </div>
    </div>
    ...
    <div class="row tile_count">
      <div class="panel transparent">
        <div class="col-md-6 hov_effect">
          <h3><strong>Total Transaction</strong> Charts - Last 30 Days</h3>
          <!-- <p>A line chart is a way of plotting data points on a line.<br>
            Often, it is used to show trend data, and the comparison of two data sets.
          </p> -->
...
@section('javascript')
    ...
    <script type="text/javascript">
      ...
      // function build_charts(){
        ...
        var processing_time_monthly      = <?php echo JSON_ENCODE($data['mon_data']['processing_time_monthly']); ?>;
        processing_time_monthly          = JSON.parse(JSON.stringify(processing_time_monthly).replace(/null/g, '"0"'));

        var config_processing_time_monthly = {
          type: 'line',
          data: {
            labels: processing_time_monthly['label'],
            datasets: [{
              label: "Total ",
              backgroundColor: "rgba(122,224,119,0.2)",
              borderColor: "rgba(0,176,76,1)",
              fill: false,
              data: processing_time_monthly['total'] ,
            }, {
              label: "Mandiri ",
              backgroundColor: "rgba(254, 182, 0,0.2)",
              borderColor: "#feb600",
              fill: false,
              data: processing_time_monthly['B002'] ,
            }, {
              label: "BNI ",
              fill: false,
              backgroundColor: "rgba(228, 83, 0,0.2)",
              borderColor: "#e45300",
              data: processing_time_monthly['B003'],
            }, {
              label: "BRI ",
              fill: false,
              backgroundColor: "rgba(0, 78, 145,0.2)",
              borderColor: "#004e91",
              data: processing_time_monthly['B012'],
            }, {
              label: "CIMB ",
              fill: false,
              backgroundColor: "rgba(192, 0, 0,0.2)",
              borderColor: "#c00000",
              data: processing_time_monthly['B008'],
            }]
          },
          options: {
            responsive: true,
        ...
        var processing_time_hourly      = <?php echo JSON_ENCODE($data['mon_data']['processing_time_hourly']); ?>;
        processing_time_hourly          = JSON.parse(JSON.stringify(processing_time_hourly).replace(/null/g, '"0"'));

        var config_processing_time_hourly = {
          type: 'line',
          data: {
            labels: processing_time_hourly['label'],
            datasets: [{
              label: "Total ",
              backgroundColor: "rgba(122,224,119,0.2)",
              borderColor: "rgba(0,176,76,1)",
              fill: false,
              data: processing_time_hourly['total'] ,
            }, {
              label: "Mandiri ",
              backgroundColor: "rgba(254, 182, 0,0.2)",
              borderColor: "#feb600",
              fill: false,
              data: processing_time_hourly['B002'] ,
            }, {
              label: "BNI ",
              fill: false,
              backgroundColor: "rgba(228, 83, 0,0.2)",
              borderColor: "#e45300",
              data: processing_time_hourly['B003'],
            }, {
              label: "BRI ",
              fill: false,
              backgroundColor: "rgba(0, 78, 145,0.2)",
              borderColor: "#004e91",
              data: processing_time_hourly['B012'],
            }, {
              label: "CIMB ",
              fill: false,
              backgroundColor: "rgba(192, 0, 0,0.2)",
              borderColor: "#c00000",
              data: processing_time_hourly['B008'],
            }]
          },
          options: {
            responsive: true,
        ...
        // window.onload = function() {
          ...
          var ctx_processing_time_monthly   = document.getElementById('proccessing-time-monthly').getContext('2d');
          var ctx_processing_time_monthly_graph   = new Chart(ctx_processing_time_monthly, config_processing_time_monthly);

          var ctx_processing_time_hourly   = document.getElementById('proccessing-time-hourly').getContext('2d');
          var ctx_processing_time_hourly_graph   = new Chart(ctx_processing_time_hourly, config_processing_time_hourly);
      ...
      function get_monitoring_data(){
        ...
        $.ajax({
          ...
          success: function (data) {
            ...
            var processing_time_monthly   = data['mon_data']['processing_time_monthly'];
            processing_time_monthly       = JSON.parse(JSON.stringify(processing_time_monthly).replace(/null/g, '"0"'));

            config_processing_time_monthly = {
              type: 'line',
              data: {
                labels: processing_time_monthly['label'],
                datasets: [{
            ...
            ctx_processing_time_monthly_graph.destroy();
            ctx_processing_time_monthly_graph  = new Chart(ctx_processing_time_monthly, config_processing_time_monthly);

            var processing_time_hourly   = data['mon_data']['processing_time_hourly'];
            processing_time_hourly       = JSON.parse(JSON.stringify(processing_time_hourly).replace(/null/g, '"0"'));

            config_processing_time_hourly = {
              type: 'line',
              data: {
                labels: processing_time_hourly['label'],
                datasets: [{
            ...
            ctx_processing_time_hourly_graph.destroy();
            ctx_processing_time_hourly_graph  = new Chart(ctx_processing_time_hourly, config_processing_time_hourly);
            ...
            console.log(horizontalBarChartData_data);
            ...
            setTimeout(function(){ get_monitoring_data(); }, 600000);
