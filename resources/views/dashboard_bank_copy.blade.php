    ...
    <div class="row tile_count">
      <div class="panel transparent" style="margin-bottom: 0px">
        <div class="panel-header" style="border-bottom: none;">
          <h3><strong>Total Amount & Transaction </strong> Summary</h3>
        </div>
        <div class="panel-content row" style="padding-top: 0;">
          <div class="col-md-3 col-sm-4 col-xs-4 tile_stats_count hov_effect">
            ...
            <div class="right">
              <span class="count_top"><img src="img/rupiah.png"> Total Amount</span>
              ...
              <div class="count blue number {{ $class }}">{{ number_format($total_amount).$symbol }}</div>
          ...
          <div class="col-md-3 col-sm-4 col-xs-4 tile_stats_count hov_effect">
            <div class="left"></div>
            <div class="right">
              <span class="count_top"><i class="fa fa-retweet purple"></i> Total Transaction</span>

              <?php
                if( $total_trx == 0 ) { $class = ''; } else { $class = 'countup'; }
              ?>

              <div class="count purple number {{ $class }}" data-from="0" data-to="{{ $total_trx }}"></div>
          ...
          <div class="col-md-3 col-sm-4 col-xs-4 tile_stats_count hov_effect">
            ...
            <div class="right">
              ...
              <div class="count green number {{ $class }}" data-from="0" data-to="{{ $total_trx_success }}"></div>
          ...
          <div class="col-md-3 col-sm-4 col-xs-4 tile_stats_count hov_effect">
            ...
            <div class="right">
              ...
              <div class="count red number {{ $class }}" data-from="0" data-to="{{ $total_trx_failed }}"></div>
