...
<style type="text/css">
  ...
  <div class="header panel-header" style="border-bottom: none;">
      <h2><i class="fas fa-home"></i> <strong>Download Detail Report - Branch</strong></h3>
  </div>
  <div class="row">
    <div class="col-md-4">
      ...
      <div class="panel no-bd bd-3 panel-stat">
          ...
          <div class="panel-body p-15 p-b-0">
              <div class="panel-content widget-info">
                    ...
                    <div class="row">
                      <form id="ListReportSettlementTable_form" method="POST" action="/download_detail_report_branch/filter_report_table_settlement">
                      <!--
                      <div class="col-md-3">
                        <div class="form-group">
                          <label for="exampleInputEmail1">Branch</label>
                  ...
                  <div class="row" id="box-result2" style="display:none">
                    <form id="listReportSettlement_form" method="POST" action="/download_detail_report_branch/zip_list_report">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
...
/*
  $.ajax({
    dataType: 'JSON',
    type: 'GET',
    url: '/download_detail_report_branch/get_list_report',
...
$("#ListReportTable_form").submit(function(e) {
    ...
    $.ajax({
      ...
      url: '/download_detail_report_branch/filter_report_table',
...
$("#ListReportSettlementTable_form").submit(function(e) {
    ...
    $.ajax({
      ...
      url: '/download_detail_report_branch/filter_report_table_settlement',
      headers: {'X-CSRF_TOKEN': "{{ csrf_token() }}" },
        success: function(data){
	...
	// Handle click on "Select all" control
   $('#example-select-alls').on('click', function(){
      // Check/uncheck all checkboxes in the table
      var rows = tableListReportSettlement.rows({ 'search': 'applied' }).nodes();
      $('input[type="checkbox"]', rows).prop('checked', this.checked);
   });
