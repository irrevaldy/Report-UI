        ...
        var config = {
          ...
          data: {
            ...
            datasets: [{
              ...
              borderColor: "#B00000",
              data: [
                trx_success_decline_data[6]['total_decline'], 

                trx_success_decline_data[5]['total_decline'], 

                trx_success_decline_data[4]['total_decline'],

                trx_success_decline_data[3]['total_decline'],

                trx_success_decline_data[2]['total_decline'],

                trx_success_decline_data[1]['total_decline'],

                trx_success_decline_data[0]['total_decline'],
              ],
            }, {
              label: "Success ",
              // fill: false,
              ...
              data: [
                ...
                trx_success_decline_data[6]['total_success'], 

                trx_success_decline_data[5]['total_success'], 

                trx_success_decline_data[4]['total_success'],

                trx_success_decline_data[3]['total_success'],

                trx_success_decline_data[2]['total_success'],

                trx_success_decline_data[1]['total_success'],

                trx_success_decline_data[0]['total_success'],
              ],
            }]
          },
          options: {
            ...
            config = {
              ...
              data: {
                ...
                datasets: [{
                  ...
                  borderColor: "#B00000",
                  data: [
                    config_data[6]['total_decline'], 

                    config_data[5]['total_decline'], 

                    config_data[4]['total_decline'],

                    config_data[3]['total_decline'],

                    config_data[2]['total_decline'],

                    config_data[1]['total_decline'],

                    config_data[0]['total_decline'],
                  ...
                  data: [
                    ...
                    config_data[6]['total_success'], 

                    config_data[5]['total_success'], 

                    config_data[4]['total_success'],

                    config_data[3]['total_success'],

                    config_data[2]['total_success'],

                    config_data[1]['total_success'],

                    config_data[0]['total_success'],
                  ],
                }]
              },
              options: {
